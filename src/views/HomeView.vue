<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Eliandra Melendres</h1>
      <div class="py-2">
        <h1
      ...
      <br>
      <a href="/Eliandra-Resume.pdf.pdf" download>
        <button
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-[400px] h-[600px] rounded-full border-4 border-amber-200 pict" src="/profile.jpg.jpg">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Web Developer", "UI/UX Designer", "Multimedia Designer", "Graphics Designer", "Tech Enthusiast"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
