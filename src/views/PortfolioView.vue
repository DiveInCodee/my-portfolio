    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          status: 'A self-initiated Figma project exploring parallax-style transitions using click-based navigation. The design showcases Asian cuisine with layered visual depth, vibrant imagery, and smooth section changes for an engaging user experience.',
          tech: 'Figma',
          github: 'null',
